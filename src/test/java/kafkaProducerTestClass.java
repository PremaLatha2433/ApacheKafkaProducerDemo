import com.apache.kafka.ApacheKafkaDemoApplication;
...
@SpringBootTest(classes = ApacheKafkaDemoApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@Testcontainers
public class kafkaProducerTestClass {
   ...
   static KafkaContainer kafka = new KafkaContainer(DockerImageName.parse("confluentinc/cp-kafka:6.2.1"));
    ...
    public void testSendEventsToTopic(){
        publisher.sendMessageObjectToTopic(new Customer(1,"prema","prema@gmail.com","9876576878"));
